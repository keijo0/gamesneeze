        ...
        if (ImGui::BeginTabItem("Misc")) {
            ...
            ImGui::BeginChild("Movement", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.38, ImGui::GetWindowHeight() * 0.326f), true); {
                ...
                if (CONFIGBOOL("Misc>Misc>Movement>LongJump")) {
                    static bool toggled = false;
                    Menu::CustomWidgets::drawKeyBinder("Key", &CONFIGINT("Misc>Misc>Movement>LongJump Key"), &toggled);
                    ImGui::SameLine();
                }
                ImGui::Checkbox("LongJump", &CONFIGBOOL("Misc>Misc>Movement>LongJump"));
                if (CONFIGBOOL("Misc>Misc>Movement>MiniJump")) {
                    static bool toggled = false;
                    Menu::CustomWidgets::drawKeyBinder("Key", &CONFIGINT("Misc>Misc>Movement>MiniJump Key"), &toggled);
                    ImGui::SameLine();
                }
                ImGui::Checkbox("MiniJump", &CONFIGBOOL("Misc>Misc>Movement>MiniJump"));
                ImGui::Checkbox("PixelSurf", &CONFIGBOOL("Misc>Misc>Movement>PixelSurf"));
                ImGui::Checkbox("AutoAlign", &CONFIGBOOL("Misc>Misc>Movement>AutoAlign"));
                if (CONFIGBOOL("Misc>Misc>Movement>FireMan")) {
                    static bool toggled = false;
                    Menu::CustomWidgets::drawKeyBinder("Key", &CONFIGINT("Misc>Misc>Movement>FireMan Key"), &toggled);
                    ImGui::SameLine();
                }
                ImGui::Checkbox("FireMan", &CONFIGBOOL("Misc>Misc>Movement>FireMan"));
                if (CONFIGBOOL("Misc>Misc>Movement>Airstuck")) {
                    static bool toggled = false;
                    Menu::CustomWidgets::drawKeyBinder("Key", &CONFIGINT("Misc>Misc>Movement>Airstuck Key"), &toggled);
                    ImGui::SameLine();
                }
                ...
                ImGui::Checkbox("Show Indicators", &CONFIGBOOL("Misc>Misc>Movement>Show Indicators"));
