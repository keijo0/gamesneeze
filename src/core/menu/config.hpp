...
namespace Config {
    ...
    inline std::unordered_map<std::string_view, ConfigItem> config {
        ...
        // Misc {
            ...
            CONFIGITEM("Misc>Misc>Movement>LongJump", false),
            CONFIGITEM("Misc>Misc>Movement>LongJump Key", 0),
            CONFIGITEM("Misc>Misc>Movement>MiniJump", false),
            CONFIGITEM("Misc>Misc>Movement>MiniJump Key", 0),
            ...
            CONFIGITEM("Misc>Misc>Movement>PixelSurf", false),
            CONFIGITEM("Misc>Misc>Movement>AutoAlign", false),
            CONFIGITEM("Misc>Misc>Movement>FireMan", false),
