...
namespace Hooks {
    ...
    void initLegacy();
    void init() {
        LOG("Legacy hook initialization starting...");
        initLegacy();
    }
    ...
    void initLegacy() {
        ...
        MARKER("hook-loadfiles");
        if (Interfaces::fileSystem)
        ...
        MARKER("hook-eventlistener");
        eventListener = new EventListener;
        hooksInitialized = true;
        MARKER("hook-all-done");
    }
    ...
    bool CreateMove::hook(void* thisptr, float flInputSampleTime, CUserCmd* cmd) {
        ...
        if (Interfaces::restoreEntityToPredictedFrame)
