...
namespace Visuals {
    ...
    void watermark() {
        ...
        ImGui::Begin("watermark", nullptr, ImGuiWindowFlags_NoDecoration | ImGuiWindowFlags_AlwaysAutoResize | ImGuiWindowFlags_NoInputs | ImGuiWindowFlags_NoMouseInputs);
        ImGui::TextColored(ImVec4(1.0f, 0.8f, 0.2f, 1.0f), "eclipse loaded");
        ImGui::End();
        ImGui::PopStyleColor();
    }
}