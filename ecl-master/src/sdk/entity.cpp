...
bool Entity::visCheck() {
    ...
    bool smokeCheck = Interfaces::lineGoesThroughSmoke ? 
        !Interfaces::lineGoesThroughSmoke(EntityCache::localPlayer->eyepos(), this->eyepos(), 1) : true;

    return (traceToHead.m_pEntityHit == this) && (traceToUpperSpinal.m_pEntityHit == this) && smokeCheck;
}
